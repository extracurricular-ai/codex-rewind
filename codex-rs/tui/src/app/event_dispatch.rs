...
impl App {
    pub(crate) async fn handle_event(
        ...
        match event {
            ...
            AppEvent::ForkSessionForPromptEdit { thread_id, selected_cell, prompt, restore_files } => {
                self.fork_for_rewind(tui, app_server, thread_id, selected_cell, prompt, restore_files).await;
            }
            AppEvent::RevertSessionForPromptEdit {
                thread_id,
                selected_cell,
