...
class ThreadRestoreFilesToTurnParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    thread_id: Annotated[str, Field(alias="threadId")]
    turn_id: Annotated[
        ...
        Field(
            alias="turnId",
            description="Turn whose start state the workspace should be returned to.",
        ),
    ]


class ThreadRestoreFilesToTurnResponse(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    summary: Annotated[
        str | None,
        Field(
            description="Null when the thread is not tracking snapshots or the turn has none, which callers should report rather than treat as success."
        ),
    ] = None
...
class ThreadUndoFileRestoreParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ThreadUndoFileRestoreResponse(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    summary: Annotated[
        str | None,
        Field(
            description="Null when the thread has no restore to undo, which callers should report rather than treat as success."
        ),
    ] = None
...
class ThreadRestoreFilesToTurnRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[
        Literal["thread/restoreFilesToTurn"], Field(title="Thread/restoreFilesToTurnRequestMethod")
    ]
    params: ThreadRestoreFilesToTurnParams


class ThreadUndoFileRestoreRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[
        Literal["thread/undoFileRestore"], Field(title="Thread/undoFileRestoreRequestMethod")
    ]
...
class ClientRequest(
    RootModel[
        ...
        | ThreadResumeRequest
        | ThreadForkRequest
        | ThreadRestoreFilesToTurnRequest
        | ThreadUndoFileRestoreRequest
